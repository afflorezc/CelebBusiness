    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 icon-box">
                ...
                <p class="description">24-7 access to your account and our experts</p>
            </div>
            <div class="col-lg-4 col-md-6 icon-box">
                <div class="icon"><i class="icofont-chart-bar-graph"></i></div>
                <h4 class="title"><a href="">Statistics</a></h4>
                <p class="description">Easy to understand management reports about all your business decisions including
                the most important detailed tax reports
                </p>
            </div>
            <div class="col-lg-4 col-md-6 icon-box">
            ...
            <div class="col-lg-4 col-md-6 icon-box">
                ...
                <p class="description">A space where we help you to organize your tedious schedule and
                various responsailities
                </p>
            </div>
        </div>
